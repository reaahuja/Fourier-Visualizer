...
int digits[1] = {
    0b11111100011000110001100011000111111,
    0b00001000010000100001000010000100001};  // Fill in with num patterns for 1
                                             // through 9 - prints (currently) a
                                             // 5 x 7 grid - 7 rows, 5 cols
